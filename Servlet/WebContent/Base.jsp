...
<html>
  ...
  <body>
    ...
    <!--get使用相对路径访问 -->
    <a href="Forward_ServletOut">Get方式相对路径请求HelloServlet</a><br><br>
    
    <!-- 使用绝对路径 访问HelloServlet_jsp_html,可以使用path变量:path变量表示项目的根目录   -->
    <a href="<%=path%>/Forward_ServletOut">Get绝对路径访问HelloServlet!</a><br><br>
     
    <!--post使用相对路径访问 -->
    <form  action="Forward_ServletOut"  method="post">
